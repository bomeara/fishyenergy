...
- Explore spatial variation in the performance of southern flounder
...
- Use bioenergetics modeling to simulate individual performance metrics
  across 8,862 1-square-km grid cells.
...
Retain only one focal species, southern flounder *Paralichthys
lethostigma*, and look at these data.
...
In brief, this dataset provides daily ocean/estuary surface temperatures
along the western coast of the Gulf of Mexico. See Du & Park (2024) and
Wright *et al.* (2025) for details. In fishyenergy, we provide a
1-square-km resolution raster layer of these temperatures.

Load this dataset called **temps_bayc** in fishyenergy and map the
...
Surface water temperatures on January 1st range from approximately 13 to
22°C along the Texas Gulf Coast. On August 1st, temperatures range from
27 to 32°C.

### Simulate bioenergetic performance

Run the **bem_project** function to grow a fish for n habitat patches
(*i.e.*, 8,862 raster cells). Be sure to set the is.raster argument to
TRUE because the temperature input is a raster and not in tabular form.
...
#> [1] "Run time is 40.43 minutes for 8862 habitat patches"
```
...
the 8,862 raster cells. Below we map the energy budget for January
because winter performance of juvenile flounder is a hypothesized driver
of population declines in recent decades along the western coast of the
Gulf of Mexico (Erickson *et al.* 2021, Froeschke *et al.* 2013).
...
- Du, J., Park, K., (2024) Development of a Cross-Scale Hydrodynamic
  Model for All Texas Coastal Waters, Final Report \#2300012715
  submitted to Texas Water Development Board.
- Erickson, K. A., West, J., Dance, M. A., Farmer, T. M., Ballenger, J.
  C., & Midway, S. R. (2021). Changing climate associated with the
  rangewide decline of an estuarine finfish. Global Change Biology 27:
  2520–2536.
- Froeschke, B.F., Tissot, P.E., Stunz, G.W., & Froeschke, J.T. (2013).
  Spatiotemporal predictive models for juvenile Southern Flounder in
  Texas estuaries. North American Journal of Fisheries Management 33:
  817–828.
- Hanson, P. C., Johnson, T. B., Schindler, D. E., & Kitchell, J. F.
  (1997). Fish bioenergetics 3.0 for Windows.
- Wright, K., Du, J., Park, K., Kiaghadi, A. (2025) TEXAS BAYCAST: The
  Next-Generation TWDB Operational Forecast Model for the Texas Coast,
  (Version X.X.X) \[Computer Software\], Texas Water Development Board,
  <doi:10.5281/zenodo.18039256>
