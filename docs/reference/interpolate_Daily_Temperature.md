...
- end_date:
  ...
  End date for the interpolation (e.g. "2020-12-31") @param
  minimum_fraction_missing Minimum fraction of data that must be present
  to do the interpolation; otherwise, it will return NA for all
  temperatures. Default is 0.8, meaning at least 80% of the data must be
  present.
