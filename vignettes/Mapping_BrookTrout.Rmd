...
Let's modify CP and ACT to more realistic values. Specifically, we will use CP = 0.50 and ACT = 1.60 These parameter values were validated behind the scenes using the bem_validate function. See the [Validation vignette](https://bomeara.github.io/fishyenergy/articles/Validation.html) for details.
```{r}
options(width = 500)
