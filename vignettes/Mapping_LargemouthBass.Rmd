...
Let's modify CP and ACT to more realistic values. Specifically, we will use CP = 0.82 and ACT = 1.69. These parameter values were validated using age-1 largemouth bass from Watts Bar Lake in East Tennessee, USA. See the [Validation vignette](https://bomeara.github.io/fishyenergy/articles/Validation.html) for details.
```{r}
options(width = 500)
