...
The model here is adopted from https://github.com/troiamj/GB_BEM_v01, which is based on [Troia and Perkin (2022)](https://doi.org/10.1093/conphys/coac035). Datasets come from there, as well. 
...
```{r fig.alt = "Line plot showing temperature over a year"}
...
```{r fig.alt="Line plot showing mass over a year"}
