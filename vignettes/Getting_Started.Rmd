...
The **bem_validate** function provides a means of estimating difficult-to-measure parameters like CP and ACT using field- or lab-derived measurements of length-at-age to identify pairs of CP and ACT values that result in realistic end-of-year mass. See the [Validation vignette](https://bomeara.github.io/fishyenergy/articles/Validation.html) to learn this workflow.
...
### Next steps
Now that you've had a crash course in the basics of bioenergetics and growing a fish, try the [Validation vignette](https://bomeara.github.io/fishyenergy/articles/Validation.html) where you will learn to grow fish that match the growth trajectories of real fish. Reach out to package developer [Matthew Troia](mailto:matthew.troia@utsa.edu) if you have questions about fishyenergy or suggestions to make it better!
